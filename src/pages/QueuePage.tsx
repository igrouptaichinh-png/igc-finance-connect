...
export function QueuePage() {
  ...
  return (
    <>
      <section className="page-heading"><div><p>Không gian Tài chính</p><h1>Ý kiến chờ phản hồi</h1><span>Ghi nhận, phân loại và cùng các phòng ban trao đổi trên từng ý kiến.</span></div><div className="heading-stat"><UsersRound size={18} /><span><strong>4 người phụ trách</strong><small>đang sẵn sàng trao đổi</small></span></div></section>
